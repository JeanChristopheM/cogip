...
},{"react-refresh/runtime":"aeH4U"}],"bAJmG":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "61c986c4e1d33e00";
"use strict";
...
},{}],"lPINB":[function(require,module,exports) {
var $parcel$ReactRefreshHelpers$55d5 = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
var prevRefreshReg = window.$RefreshReg$;
var prevRefreshSig = window.$RefreshSig$;
$parcel$ReactRefreshHelpers$55d5.prelude(module);
...
var _chartJsx = require("../reusables/Chart.jsx");
var _chartJsxDefault = parcelHelpers.interopDefault(_chartJsx);
var _lastFiveInvoicesJsx = require("./LastFiveInvoices.jsx");
var _lastFiveInvoicesJsxDefault = parcelHelpers.interopDefault(_lastFiveInvoicesJsx);
var _lastFiveContactsJsx = require("./LastFiveContacts.jsx");
var _lastFiveContactsJsxDefault = parcelHelpers.interopDefault(_lastFiveContactsJsx);
var _lastFiveCompaniesJsx = require("./LastFiveCompanies.jsx");
var _lastFiveCompaniesJsxDefault = parcelHelpers.interopDefault(_lastFiveCompaniesJsx);
...
function Homepage({ companies , invoices , contacts , setPage , setInvoiceId  }) {
    ...
    /* Sorting data to get 5 latest addition */ invoices.sort((a, b)=>{
    ...
    return(/*#__PURE__*/ _jsxRuntime.jsxs("main", {
        className: "homepage",
        __source: {
            fileName: "src/components/dashboard/Homepage.jsx",
            lineNumber: 27,
            columnNumber: 5
        },
        __self: this,
        children: [
            /*#__PURE__*/ _jsxRuntime.jsx(_lastFiveInvoicesJsxDefault.default, {
                handleAdd: handleAdd,
                navigate: navigate,
                invoices: invoices,
                companies: companies,
            ...
            /*#__PURE__*/ _jsxRuntime.jsx(_lastFiveContactsJsxDefault.default, {
                handleAdd: handleAdd,
                navigate: navigate,
                contacts: contacts,
                companies: companies,
            ...
            /*#__PURE__*/ _jsxRuntime.jsx(_lastFiveCompaniesJsxDefault.default, {
                handleAdd: handleAdd,
                navigate: navigate,
                companies: companies,
                __source: {
            ...
            /*#__PURE__*/ _jsxRuntime.jsxs("section", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ _jsxRuntime.jsx("div", {
                        ...
                        __self: this,
                        children: invoices.length > 0 ? /*#__PURE__*/ _jsxRuntime.jsx(_chartJsxDefault.default, {
                            invoices: invoices,
                            __source: {
                                fileName: "src/components/dashboard/Homepage.jsx",
                                lineNumber: 52,
...
$RefreshReg$(_c, "Homepage");
  ...
  $parcel$ReactRefreshHelpers$55d5.postlude(module);
} finally {
  window.$RefreshReg$ = prevRefreshReg;
  window.$RefreshSig$ = prevRefreshSig;
}
},{"react/jsx-runtime":"6Ds2u","react":"4mchR","../reusables/Chart.jsx":"576vt","./LastFiveInvoices.jsx":"i8VT9","./LastFiveContacts.jsx":"kn86e","./LastFiveCompanies.jsx":"an1tR","react-router-dom":"16kZP","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"9pz13"}],"576vt":[function(require,module,exports) {
var $parcel$ReactRefreshHelpers$e7af = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
var prevRefreshReg = window.$RefreshReg$;
var prevRefreshSig = window.$RefreshSig$;
$parcel$ReactRefreshHelpers$e7af.prelude(module);
...
_chartJs.Chart.register(_chartJs.ArcElement, _chartJs.Tooltip, _chartJs.Legend);
const Chart = ({ invoices  })=>{
    ...
    const primaryColor = document.documentElement.style.getPropertyValue("--clr-text") || "#274c77";
    const secondaryColor = document.documentElement.style.getPropertyValue("--clr-text-low") || "#879cb3";
    const data = {
        labels: [
            "Paid",
            "Unpaid"
    ...
    return(/*#__PURE__*/ _jsxRuntime.jsx(_reactChartjs2.Pie, {
        options: options,
        data: data,
        __source: {
            fileName: "src/components/reusables/Chart.jsx",
            lineNumber: 38,
            columnNumber: 10
        },
        __self: undefined
...
$RefreshReg$(_c, "Chart");
  ...
  $parcel$ReactRefreshHelpers$e7af.postlude(module);
} finally {
  window.$RefreshReg$ = prevRefreshReg;
  window.$RefreshSig$ = prevRefreshSig;
}
},{"react/jsx-runtime":"6Ds2u","chart.js":"aBjy1","react-chartjs-2":"6sPiC","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"9pz13"}],"aBjy1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class DomPlatform extends BasePlatform {
    ...
    getMaximumSize(canvas3, width2, height2, aspectRatio3) {
        return _helpersSegmentJs.E(canvas3, width2, height2, aspectRatio3);
    }
    isAttached(canvas4) {
        const container = _helpersSegmentJs.F(canvas4);
...
class Element {
    ...
    tooltipPosition(useFinalPosition6) {
...
class Scale extends Element {
    ...
    _callHooks(name2) {
        ...
        _helpersSegmentJs.O(this.options[name2], [
            this
        ]);
    }
    beforeDataLimits() {
    ...
    _calculatePadding(first1, last2, sin1, cos1) {
        ...
        if (this.isHorizontal()) {
            ...
            if (isRotated) {
                if (labelsBelowTicks) {
                    paddingLeft = cos1 * first1.width;
                    paddingRight = sin1 * last2.height;
                } else {
                    paddingLeft = sin1 * first1.height;
                    paddingRight = cos1 * last2.width;
                }
...
class Registry {
    ...
    _exec(method1, registry1, component) {
        const camelMethod = _helpersSegmentJs.a3(method1);
...
class PluginService {
    ...
    _notify(descriptors, chart18, hook1, args13) {
        ...
        for (const descriptor of descriptors){
            ...
            if (_helpersSegmentJs.O(method, params, plugin) === false && args13.cancelable) return false;
        }
        return true;
    }
    invalidate() {
...
class Config {
    ...
    resolveNamedOptions(scopes2, names1, context4, prefixes2 = [
        ...
        if (needContext(resolver, names1)) {
            result.$shared = false;
            context4 = _helpersSegmentJs.a5(context4) ? context4() : context4;
            const subResolver = this.createResolver(scopes2, context4, subPrefixes);
            options = _helpersSegmentJs.a6(resolver, context4, subResolver);
        }
    ...
    createResolver(scopes1, context3, prefixes1 = [
        ...
        return _helpersSegmentJs.i(context3) ? _helpersSegmentJs.a6(resolver, context3, undefined, descriptorDefaults) : resolver;
    }
}
...
function onAnimationsComplete(context) {
    ...
    _helpersSegmentJs.O(animationOptions && animationOptions.onComplete, [
        context
    ], chart);
}
function onAnimationProgress(context) {
    const chart = context.chart;
    const animationOptions = chart.options.animation;
    _helpersSegmentJs.O(animationOptions && animationOptions.onProgress, [
        context
    ], chart);
}
...
class Chart {
    ...
    _getUniformDataChanges() {
        ...
        for(let i3 = 1; i3 < datasetCount; i3++){
            if (!_helpersSegmentJs.ae(changeSet, makeSet(i3))) return;
        }
    ...
    _updateDatasets(mode27) {
        ...
        for(let i4 = 0, ilen1 = this.data.datasets.length; i4 < ilen1; ++i4)this._updateDataset(i4, _helpersSegmentJs.a5(mode27) ? mode27({
            datasetIndex: i4
        }) : mode27);
    ...
    bindUserEvents() {
        ...
        _helpersSegmentJs.D(this.options.events, (type)=>_add(type, listener3)
        );
    }
    ...
    _getActiveElements(e3, lastActive1, inChartArea1, useFinalPosition2) {
        if (e3.type === 'mouseout') return [];
        if (!inChartArea1) return lastActive1;
        const hoverOptions = this.options.hover;
        return this.getElementsAtEventForMode(e3, hoverOptions.mode, hoverOptions, useFinalPosition2);
    }
}
...
class ArcElement extends Element {
    ...
    inRange(chartX, chartY, useFinalPosition3) {
    ...
    getCenterPoint(useFinalPosition4) {
    ...
    tooltipPosition(useFinalPosition5) {
        return this.getCenterPoint(useFinalPosition5);
    }
    draw(ctx1) {
...
class LineElement extends Element {
    ...
    updateControlPoints(chartArea, indexAxis1) {
        ...
        if ((options.tension || options.cubicInterpolationMode === 'monotone') && !options.stepped && !this._pointsUpdated) {
            ...
            _helpersSegmentJs.aj(this._points, options, chartArea, loop, indexAxis1);
...
class PointElement extends Element {
    ...
    inRange(mouseX, mouseY, useFinalPosition10) {
        const options = this.options;
        const { x , y  } = this.getProps([
            'x',
            'y'
    ...
    inXRange(mouseX1, useFinalPosition7) {
        return inRange$1(this, mouseX1, 'x', useFinalPosition7);
    }
    inYRange(mouseY1, useFinalPosition8) {
        return inRange$1(this, mouseY1, 'y', useFinalPosition8);
    }
    getCenterPoint(useFinalPosition9) {
        const { x , y  } = this.getProps([
            'x',
            'y'
        ], useFinalPosition9);
    ...
    draw(ctx4, area1) {
        ...
        _helpersSegmentJs.ar(ctx4, options, this.x, this.y);
    }
    getRange() {
        const options = this.options || {
        };
...
class BarElement extends Element {
    ...
    inRange(mouseX2, mouseY2, useFinalPosition14) {
        return inRange1(this, mouseX2, mouseY2, useFinalPosition14);
    }
    inXRange(mouseX3, useFinalPosition11) {
        return inRange1(this, mouseX3, null, useFinalPosition11);
    }
    inYRange(mouseY3, useFinalPosition12) {
        return inRange1(this, null, mouseY3, useFinalPosition12);
    }
    getCenterPoint(useFinalPosition13) {
...
class Legend extends Element {
    ...
    _getLegendItemAt(x1, y1) {
        let i, hitBox, lh;
        if (_helpersSegmentJs.ah(x1, this.left, this.right) && _helpersSegmentJs.ah(y1, this.top, this.bottom)) {
            lh = this.legendHitBoxes;
            for(i = 0; i < lh.length; ++i){
                hitBox = lh[i];
                if (_helpersSegmentJs.ah(x1, hitBox.left, hitBox.left + hitBox.width) && _helpersSegmentJs.ah(y1, hitBox.top, hitBox.top + hitBox.height)) return this.legendItems[i];
            }
        }
        return null;
    }
    handleEvent(e4) {
        const opts = this.options;
        if (!isListened(e4.type, opts)) return;
...
class Tooltip extends Element {
    constructor(config7){
        ...
        this.$animations = undefined;
        this.$context = undefined;
        this.chart = config7.chart || config7._chart;
    ...
    getBody(tooltipItems1, options10) {
        ...
        const bodyItems = [];
        _helpersSegmentJs.D(tooltipItems1, (context)=>{
            const bodyItem = {
                before: [],
                lines: [],
                after: []
    ...
    drawTitle(pt, ctx8, options16) {
        ...
        if (length) {
            const rtlHelper = _helpersSegmentJs.ax(options16.rtl, this.x, this.width);
            ...
            titleFont = _helpersSegmentJs.Z(options16.titleFont);
    ...
    _drawColorBox(ctx9, pt1, i5, rtlHelper, options17) {
        ...
        const bodyFont = _helpersSegmentJs.Z(options17.bodyFont);
        ...
        if (options17.usePointStyle) {
            ...
            _helpersSegmentJs.ar(ctx9, drawOptions, centerX, centerY);
    ...
    drawBody(pt2, ctx10, options18) {
        ...
        const bodyFont = _helpersSegmentJs.Z(options18.bodyFont);
        let bodyLineHeight = bodyFont.lineHeight;
        let xLinePadding = 0;
        const rtlHelper = _helpersSegmentJs.ax(options18.rtl, this.x, this.width);
    ...
    drawFooter(pt3, ctx11, options19) {
        ...
        let footerFont, i;
        if (length) {
            const rtlHelper = _helpersSegmentJs.ax(options19.rtl, this.x, this.width);
            ...
            footerFont = _helpersSegmentJs.Z(options19.footerFont);
    ...
    drawBackground(pt4, ctx12, tooltipSize, options20) {
        ...
        const { topLeft , topRight , bottomLeft , bottomRight  } = _helpersSegmentJs.au(options20.cornerRadius);
    ...
    draw(ctx13) {
        ...
        if (options.enabled && hasTooltipContent) {
            ...
            _helpersSegmentJs.ay(ctx13, options.textDirection);
            pt.y += padding.top;
            this.drawTitle(pt, ctx13, options);
            this.drawBody(pt, ctx13, options);
            this.drawFooter(pt, ctx13, options);
            _helpersSegmentJs.aA(ctx13, options.textDirection);
            ctx13.restore();
        }
    }
    getActiveElements() {
    ...
    handleEvent(e5, replay4, inChartArea2 = true) {
        if (replay4 && this._ignoreReplayEvents) return false;
        this._ignoreReplayEvents = false;
        const options = this.options;
        const lastActive = this._active || [];
        const active = this._getActiveElements(e5, lastActive, replay4, inChartArea2);
        const positionChanged = this._positionChanged(active, e5);
        const changed = replay4 || !_helpersSegmentJs.af(active, lastActive) || positionChanged;
        if (changed) {
            this._active = active;
    ...
    _getActiveElements(e6, lastActive2, replay5, inChartArea3) {
        const options = this.options;
        if (e6.type === 'mouseout') return [];
        if (!inChartArea3) return lastActive2;
        const active = this.chart.getElementsAtEventForMode(e6, options.mode, options, replay5);
        if (options.reverse) active.reverse();
        return active;
    }
    _positionChanged(active5, e7) {
        const { caretX , caretY , options  } = this;
        const position = positioners[options.position].call(this, active5, e7);
...
class LogarithmicScale extends Scale {
    ...
    getPixelForValue(value10) {
        ...
        return this.getPixelForDecimal(value10 === this.min ? 0 : (_helpersSegmentJs.L(value10) - this._startValue) / this._valueRange);
    }
...
class RadialLinearScale extends LinearScaleBase {
    ...
    getIndexAngle(index40) {
        ...
        return _helpersSegmentJs.aw(index40 * angleMultiplier + _helpersSegmentJs.t(startAngle));
    }
    ...
    getPointPosition(index36, distanceFromCenter, additionalAngle = 0) {
        const angle = this.getIndexAngle(index36) - _helpersSegmentJs.H + additionalAngle;
        return {
...
parcelHelpers.export(exports, "O", ()=>callback1
);
...
parcelHelpers.export(exports, "a4", ()=>descriptors1
);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"6sPiC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function ChartComponent({ height =150 , width =300 , redraw =false , datasetIdKey , type , data , options , plugins =[] , fallbackContent , ...props }, ref) {
    ...
    const chartRef = _react.useRef();
    const renderChart = ()=>{
        if (!canvasRef.current) return;
        chartRef.current = new _chartJs.Chart(canvasRef.current, {
            type,
    ...
    return(/*#__PURE__*/ _reactDefault.default.createElement("canvas", Object.assign({
        ref: canvasRef,
        role: "img",
        height: height,
        width: width
...
const Chart = /*#__PURE__*/ _react.forwardRef(ChartComponent);
function createTypedChart(type, registerables) {
    _chartJs.Chart.register(registerables);
    return(/*#__PURE__*/ _react.forwardRef((props, ref)=>/*#__PURE__*/ _reactDefault.default.createElement(Chart, Object.assign({
        }, props, {
            ref: ref,
            type: type
        }))
...
const Line = /* #__PURE__ */ createTypedChart('line', _chartJs.LineController);
const Bar = /* #__PURE__ */ createTypedChart('bar', _chartJs.BarController);
const Radar = /* #__PURE__ */ createTypedChart('radar', _chartJs.RadarController);
const Doughnut = /* #__PURE__ */ createTypedChart('doughnut', _chartJs.DoughnutController);
const PolarArea = /* #__PURE__ */ createTypedChart('polarArea', _chartJs.PolarAreaController);
const Bubble = /* #__PURE__ */ createTypedChart('bubble', _chartJs.BubbleController);
const Pie = /* #__PURE__ */ createTypedChart('pie', _chartJs.PieController);
const Scatter = /* #__PURE__ */ createTypedChart('scatter', _chartJs.ScatterController);

},{"react":"4mchR","chart.js":"aBjy1","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"i8VT9":[function(require,module,exports) {
var $parcel$ReactRefreshHelpers$22e6 = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
var prevRefreshReg = window.$RefreshReg$;
var prevRefreshSig = window.$RefreshSig$;
$parcel$ReactRefreshHelpers$22e6.prelude(module);

try {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _jsxRuntime = require("react/jsx-runtime");
var _invoiceLiJsx = require("../reusables/InvoiceLi.jsx");
var _invoiceLiJsxDefault = parcelHelpers.interopDefault(_invoiceLiJsx);
const LastFiveInvoices = ({ handleAdd , navigate , invoices , companies , setPage , setInvoiceId ,  })=>{
    return(/*#__PURE__*/ _jsxRuntime.jsxs("section", {
        className: "invoices card",
        __source: {
            fileName: "src/components/dashboard/LastFiveInvoices.jsx",
            lineNumber: 11,
            columnNumber: 5
        },
        __self: undefined,
        children: [
            ...
            /*#__PURE__*/ _jsxRuntime.jsx("ul", {
                ...
                __self: undefined,
                children: invoices.length > 0 ? invoices.slice(0, 5).map((entry)=>{
                    return(/*#__PURE__*/ _jsxRuntime.jsx(_invoiceLiJsxDefault.default, {
                        invoice: entry,
                        companies: companies,
                        setPage: setPage,
                        setInvoiceId: setInvoiceId,
...
_c = LastFiveInvoices;
exports.default = LastFiveInvoices;
var _c;
$RefreshReg$(_c, "LastFiveInvoices");

  $parcel$ReactRefreshHelpers$22e6.postlude(module);
} finally {
  window.$RefreshReg$ = prevRefreshReg;
  window.$RefreshSig$ = prevRefreshSig;
}
},{"react/jsx-runtime":"6Ds2u","../reusables/InvoiceLi.jsx":"gwPGP","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"9pz13"}],"gwPGP":[function(require,module,exports) {
var $parcel$ReactRefreshHelpers$83f7 = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
var prevRefreshReg = window.$RefreshReg$;
var prevRefreshSig = window.$RefreshSig$;
$parcel$ReactRefreshHelpers$83f7.prelude(module);
...
function InvoiceLi({ invoice , companies  }) {
    ...
    let company1 = companies.find((company)=>company.id === invoice.company
    );
    let arrow = company1.status === "Client" ? "down" : "up";
    return(/*#__PURE__*/ _jsxRuntime.jsxs("li", {
        className: "invoiceLi",
        __source: {
            fileName: "src/components/reusables/InvoiceLi.jsx",
            lineNumber: 9,
            columnNumber: 5
        },
        __self: this,
        children: [
            ...
            /*#__PURE__*/ _jsxRuntime.jsx("span", {
                ...
                __self: this,
                children: _dateFormatter.dateFormatter(invoice.received)
            })
        ]
    }));
}
_s(InvoiceLi, "CzcTeTziyjMsSrAVmHuCCb6+Bfg=", false, function() {
    return [
        _reactRouterDom.useNavigate
    ];
});
_c = InvoiceLi;
exports.default = InvoiceLi;
var _c;
$RefreshReg$(_c, "InvoiceLi");

  $parcel$ReactRefreshHelpers$83f7.postlude(module);
} finally {
  window.$RefreshReg$ = prevRefreshReg;
  window.$RefreshSig$ = prevRefreshSig;
}
},{"react/jsx-runtime":"6Ds2u","react-router-dom":"16kZP","../../logic/dateFormatter":"7VZgQ","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"9pz13"}],"7VZgQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"kn86e":[function(require,module,exports) {
var $parcel$ReactRefreshHelpers$a8c6 = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
var prevRefreshReg = window.$RefreshReg$;
var prevRefreshSig = window.$RefreshSig$;
$parcel$ReactRefreshHelpers$a8c6.prelude(module);

try {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _jsxRuntime = require("react/jsx-runtime");
var _contactLiJsx = require("../reusables/ContactLi.jsx");
var _contactLiJsxDefault = parcelHelpers.interopDefault(_contactLiJsx);
const LastFiveContacts = ({ handleAdd , navigate , contacts , companies  })=>{
    return(/*#__PURE__*/ _jsxRuntime.jsxs("section", {
        className: "contacts card",
        __source: {
            fileName: "src/components/dashboard/LastFiveContacts.jsx",
            lineNumber: 4,
            columnNumber: 5
        },
        __self: undefined,
        children: [
            ...
            /*#__PURE__*/ _jsxRuntime.jsx("ul", {
                ...
                __self: undefined,
                children: contacts.length > 0 ? contacts.slice(0, 5).map((entry)=>{
                    return(/*#__PURE__*/ _jsxRuntime.jsx(_contactLiJsxDefault.default, {
                        contact: entry,
                        companies: companies,
                        __source: {
                            fileName: "src/components/dashboard/LastFiveContacts.jsx",
...
_c = LastFiveContacts;
exports.default = LastFiveContacts;
var _c;
$RefreshReg$(_c, "LastFiveContacts");

  $parcel$ReactRefreshHelpers$a8c6.postlude(module);
} finally {
  window.$RefreshReg$ = prevRefreshReg;
  window.$RefreshSig$ = prevRefreshSig;
}
},{"react/jsx-runtime":"6Ds2u","../reusables/ContactLi.jsx":"8pUoM","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"9pz13"}],"8pUoM":[function(require,module,exports) {
var $parcel$ReactRefreshHelpers$cfa7 = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
var prevRefreshReg = window.$RefreshReg$;
var prevRefreshSig = window.$RefreshSig$;
$parcel$ReactRefreshHelpers$cfa7.prelude(module);
...
function ContactLi({ contact , companies  }) {
  ...
  ); */ let company = contact.companies.length === 0 ? "No company yet" : contact.companies.length === 1 ? companies.find((el)=>el.id === contact.companies[0]
    ) : "Multiple";
    return(/*#__PURE__*/ _jsxRuntime.jsxs("li", {
        __source: {
            fileName: "src/components/reusables/ContactLi.jsx",
            lineNumber: 15,
            columnNumber: 5
        },
        __self: this,
        children: [
            ...
            typeof company === "string" ? /*#__PURE__*/ _jsxRuntime.jsx("span", {
...
_s(ContactLi, "CzcTeTziyjMsSrAVmHuCCb6+Bfg=", false, function() {
    return [
        _reactRouterDom.useNavigate
    ];
});
_c = ContactLi;
exports.default = ContactLi;
var _c;
$RefreshReg$(_c, "ContactLi");

  $parcel$ReactRefreshHelpers$cfa7.postlude(module);
} finally {
  window.$RefreshReg$ = prevRefreshReg;
  window.$RefreshSig$ = prevRefreshSig;
}
},{"react/jsx-runtime":"6Ds2u","react-router-dom":"16kZP","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"9pz13"}],"an1tR":[function(require,module,exports) {
var $parcel$ReactRefreshHelpers$0d2c = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
var prevRefreshReg = window.$RefreshReg$;
var prevRefreshSig = window.$RefreshSig$;
$parcel$ReactRefreshHelpers$0d2c.prelude(module);

try {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _jsxRuntime = require("react/jsx-runtime");
var _companyLiJsx = require("../reusables/CompanyLi.jsx");
var _companyLiJsxDefault = parcelHelpers.interopDefault(_companyLiJsx);
const LastFiveCompanies = ({ handleAdd , navigate , companies  })=>{
    return(/*#__PURE__*/ _jsxRuntime.jsxs("section", {
        className: "companies card",
        __source: {
            fileName: "src/components/dashboard/LastFiveCompanies.jsx",
            lineNumber: 5,
            columnNumber: 5
        },
        __self: undefined,
        children: [
            ...
            /*#__PURE__*/ _jsxRuntime.jsx("ul", {
                ...
                __self: undefined,
                children: companies.length > 0 ? companies.slice(0, 5).map((entry)=>{
                    return(/*#__PURE__*/ _jsxRuntime.jsx(_companyLiJsxDefault.default, {
                        company: entry,
                        __source: {
                            fileName: "src/components/dashboard/LastFiveCompanies.jsx",
                            lineNumber: 27,
...
_c = LastFiveCompanies;
exports.default = LastFiveCompanies;
var _c;
$RefreshReg$(_c, "LastFiveCompanies");

  $parcel$ReactRefreshHelpers$0d2c.postlude(module);
} finally {
  window.$RefreshReg$ = prevRefreshReg;
  window.$RefreshSig$ = prevRefreshSig;
}
},{"react/jsx-runtime":"6Ds2u","../reusables/CompanyLi.jsx":"hLZMb","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"9pz13"}],"hLZMb":[function(require,module,exports) {
var $parcel$ReactRefreshHelpers$d519 = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
var prevRefreshReg = window.$RefreshReg$;
var prevRefreshSig = window.$RefreshSig$;
$parcel$ReactRefreshHelpers$d519.prelude(module);
...
function CompanyLi({ company  }) {
    ...
    return(/*#__PURE__*/ _jsxRuntime.jsxs("li", {
        __source: {
            fileName: "src/components/reusables/CompanyLi.jsx",
            lineNumber: 6,
            columnNumber: 5
        },
        __self: this,
...
_s(CompanyLi, "CzcTeTziyjMsSrAVmHuCCb6+Bfg=", false, function() {
    return [
        _reactRouterDom.useNavigate
    ];
});
_c = CompanyLi;
exports.default = CompanyLi;
var _c;
$RefreshReg$(_c, "CompanyLi");

  $parcel$ReactRefreshHelpers$d519.postlude(module);
} finally {
  window.$RefreshReg$ = prevRefreshReg;
  window.$RefreshSig$ = prevRefreshSig;
}
},{"react/jsx-runtime":"6Ds2u","react-router-dom":"16kZP","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV","@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js":"9pz13"}]},["emU3S","bAJmG"], null, "parcelRequire30d9")

//# sourceMappingURL=Homepage.e1d33e00.js.map
