...
},{"react-refresh/runtime":"aeH4U"}],"ldS7D":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "8b304c75cc6af6bb";
"use strict";
...
},{}],"6tPwS":[function(require,module,exports) {
var $parcel$ReactRefreshHelpers$414f = require("@parcel/transformer-react-refresh-wrap/lib/helpers/helpers.js");
var prevRefreshReg = window.$RefreshReg$;
var prevRefreshSig = window.$RefreshSig$;
$parcel$ReactRefreshHelpers$414f.prelude(module);
...
function Invoices({ invoices , contacts , companies  }) {
    ...
    /* SETTING UP TABLE */ const data = _react.useMemo(()=>{
        ...
        for (let entry of invoices){
            ...
            let obj = {
                icon: /*#__PURE__*/ _jsxRuntime.jsx("i", {
                    className: `fas fa-arrow-${arrow}`,
                    __source: {
                        fileName: "src/components/invoices/Invoices.jsx",
                        lineNumber: 31,
                        columnNumber: 15
                    },
                    __self: this
                ...
                col7: _dateFormatter.dateFormatter(entry.received),
    ...
    const handleClick = (header, contactName, companyName, invoiceId)=>{
        switch(header){
            case "Contact":
                if (contactName !== "None") navigate(`/contact/${contacts.find((el)=>`${el.firstname} ${el.lastname}` == contactName
                ).id}`);
                break;
            case "Company":
                navigate(`/company/${companies.find((el)=>el.name == companyName
                ).id}`);
                break;
            case "Reference":
                                    ...
                                    return(/*#__PURE__*/ _jsxRuntime.jsx("tr", {
                                        ...
                                        children: row.cells.map((cell)=>{
                                            return(/*#__PURE__*/ _jsxRuntime.jsx("td", {
                                                ...
                                                onClick: ()=>{
                                                    handleClick(cell.column.Header, cell.row.allCells[6].value, cell.row.allCells[5].value, cell.row.allCells[9].value);
                                                },
                                                __source: {
                                                    fileName: "src/components/invoices/Invoices.jsx",
                                                    lineNumber: 223,
...
_s(Invoices, "ZyiTlFu2WBY8JAd5iUi+fvBsVQY=", false, function() {
    return [
...
$RefreshReg$(_c, "Invoices");
  ...
  $parcel$ReactRefreshHelpers$414f.postlude(module);
} finally {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["emU3S","ldS7D"], null, "parcelRequire30d9")

//# sourceMappingURL=Invoices.cc6af6bb.js.map
