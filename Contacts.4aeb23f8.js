...
},{"react-refresh/runtime":"aeH4U"}],"02glr":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "4eabd10a4aeb23f8";
"use strict";
...
},{}],"hddTD":[function(require,module,exports) {
        ...
        for (let contact of contacts){
            let obj = {
                icon: /*#__PURE__*/ _jsxRuntime.jsx("i", {
                    ...
                    __source: {
                        fileName: "src/components/contacts/Contacts.jsx",
                        lineNumber: 27,
                        columnNumber: 15
                    },
                    __self: this
                ...
                col4: contact.companies.length === 0 ? "None" : contact.companies.length === 1 ? companies.find((el)=>el.id == contact.companies[0]
                ).name : companies.filter((el)=>{
                    if (contact.companies.includes(el.id)) return el;
                }).reduce((acc, current)=>{
                    return acc += current.name + ", ";
                }, "").slice(0, -2),
                col5: _dateFormatter.dateFormatter(contact.added),
                id: contact.id
            };
            results.push(obj);
        }
                                    ...
                                    return(/*#__PURE__*/ _jsxRuntime.jsx("tr", {
                                        ...
                                        children: row.cells.map((cell)=>{
                                            return(/*#__PURE__*/ _jsxRuntime.jsx("td", {
                                                ...
                                                onClick: ()=>{
                                                    handleClick(cell.column.Header, cell.row.allCells[6].value, cell.row.allCells[4].value);
                                                },
                                                __source: {
                                                    fileName: "src/components/contacts/Contacts.jsx",
                                                    lineNumber: 200,
...
_s(Contacts, "ZyiTlFu2WBY8JAd5iUi+fvBsVQY=", false, function() {
    return [
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["emU3S","02glr"], null, "parcelRequire30d9")

//# sourceMappingURL=Contacts.4aeb23f8.js.map
